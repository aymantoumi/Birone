...
export default function Authenticated({ user, header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
            <nav className="bg-sky-800 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 sticky top-0">
            ...
            {header && (
                <header className="bg-sky-600 dark:bg-gray-800 shadow">
